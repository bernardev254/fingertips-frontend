<template>
    ...
    <div class="head">
        ...
        <button @click="openMyApp">open app</button>
    </div>
    
    
    <div class="main">
        <div class="left">
            <p>Fingertips Bookmarking Manager</p>
                
            <h2>...all your bookmarks on your fingertips</h2>
            <div class="foot">
                <button @click="openMyApp"> open app</button>
        ...
        <div class="right">
            <img src="../assets/fingertips2.png">                        
        </div>
